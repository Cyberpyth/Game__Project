...
class Game:
    ...
    def __init__(self):
        #definiri si notre jeu a commencé ou non
    ...
    def update(self, screen):
        ...
        #actualiser l'animation du joeuur
        ...
        #appliquer l'ensemble des images de mon grouupe de comet
        self.comet_event.all_comets.draw(screen)

        # Appliquer l'ensemble des images de mon groupe de monstre
        self.all_monsters.draw(screen)

        # Verifier si le joueur souhaite aller a gauche ou a drotie
